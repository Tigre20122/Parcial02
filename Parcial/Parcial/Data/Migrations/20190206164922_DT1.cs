        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CelularContacto = table.Column<string>(maxLength: 13, nullable: false),
                    Direccion = table.Column<string>(maxLength: 50, nullable: false),
                    Extencion = table.Column<string>(maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Provedor", x => x.IdProvedor);
                });
